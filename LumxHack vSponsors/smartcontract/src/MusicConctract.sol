...
contract MusicContract is ERC1155, ERC1155Pausable {
    ...
    function addMembers(address[] memory members_, uint256[] memory percentages_) public {
    ...
    function addPlataforms(address[] memory plataforms_) public {
    ...
    function returnMembers() public view returns (Members[] memory){
        return members;
    }
}